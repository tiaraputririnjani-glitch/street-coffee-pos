...
<head>
    ...
    <title>Street Coffee POS - Master Priority Edition</title>
...
<body class="bg-gray-100 font-sans text-gray-900">
        ...
        <div class="flex-1 p-4 md:p-8 overflow-y-auto h-full bg-gray-50/50 custom-scroll">
            ...
            <div id="section-pos" class="space-y-8 no-print">
                <div class="flex justify-between items-center">
                    ...
                    <div onclick="switchTab('rekap')" class="bg-orange-500 p-4 md:p-5 rounded-[2rem] shadow-xl text-white text-right cursor-pointer hover:bg-orange-600 hover:scale-105 transition-all">
                        <span class="text-[9px] uppercase font-black opacity-70 block tracking-widest">Pendapatan Hari Ini ⬇️</span>
            ...
            <div id="section-rekap" class="hidden space-y-6 print-area">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    ...
                    <div id="total-card-click" onclick="document.getElementById('report-table-harian').scrollIntoView({behavior:'smooth'})" class="bg-orange-500 p-8 rounded-[2.5rem] shadow-lg text-white text-center cursor-pointer hover:bg-orange-600 hover:scale-105 transition-all">
                ...
                <div id="report-table-harian" class="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100">
    ...
    <script>
        ...
        function updateUIWithActiveShift() {
            ...
            if(isOwner) {
                greeting.innerHTML = "HAI OWNER! ☕"; // KUNCI MATI GREETING OWNER
        ...
        // 3. UTILS (SEARCH, TAB, GUDANG, VOID)
