...
<body class="bg-gray-100 font-sans text-gray-900">
    ...
    <div id="shift-modal" class="fixed inset-0 bg-black/95 hidden items-center justify-center z-[1000] p-4 backdrop-blur-2xl no-print">
    ...
    <div id="close-shift-modal" class="fixed inset-0 bg-black/80 hidden items-center justify-center z-[900] p-4 backdrop-blur-md no-print">
        <div class="bg-white w-full max-w-sm rounded-[3rem] p-10 text-center shadow-2xl relative border-4 border-gray-900">
            ...
            <div class="mb-8 relative">
                ...
                <input type="number" id="closing-cash" placeholder="0" class="w-full p-5 pl-14 bg-gray-50 border rounded-3xl outline-none text-center text-xl font-black text-orange-600 focus:ring-4 focus:ring-orange-100">
            </div>
        ...
        <div class="flex-1 p-4 md:p-8 overflow-y-auto h-full bg-gray-50/50 custom-scroll">
            ...
            <div id="section-rekap" class="hidden space-y-6 print-area">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm text-center"><p class="text-[10px] font-black text-gray-400 uppercase mb-2 tracking-widest">Saldo Tunai</p><p id="rekap-cash-display" class="text-2xl font-black text-green-600 tracking-tighter">Rp 0</p></div>
                    <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm text-center"><p class="text-[10px] font-black text-gray-400 uppercase mb-2 tracking-widest">Saldo Digital</p><p id="rekap-digital-display" class="text-2xl font-black text-blue-600 tracking-tighter">Rp 0</p></div>
                    <div onclick="document.getElementById('daily-report-section').scrollIntoView({behavior:'smooth'})" class="bg-orange-500 p-8 rounded-[2.5rem] shadow-lg text-white text-center cursor-pointer hover:bg-orange-600 hover:scale-105 transition-all">
    ...
    <div id="inventory-modal" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-[2000] p-4 backdrop-blur-sm no-print">
    ...
    <div id="receipt-modal" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-[3000] p-4 backdrop-blur-sm">
    ...
    <script>
        ...
        function updateUIWithActiveShift() {
            ...
            if(isOwner) {
                ...
                document.getElementById('active-cashier-label').innerText = name ? "Shift Kasir: " + name : "Belum Ada Kasir";
            } else if(name) {
